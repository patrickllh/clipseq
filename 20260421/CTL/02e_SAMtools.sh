...
mappings=(
SNRNP70-Con-rep1_L1_R1.genome.Aligned.out.bam
SNRNP70-Con-rep2_L2_R1.genome.Aligned.out.bam
mVenus-Con-rep5_L1_R1.genome.Aligned.out.bam
mVenus-Con-rep6_L2_R1.genome.Aligned.out.bam
)
