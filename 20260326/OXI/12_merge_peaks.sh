...
ip_reads=(
SNRNP70-SA-rep1_L1_R1.genome.Aligned.sort.dedup.bam
SNRNP70-SA-rep2_L2_R1.genome.Aligned.sort.dedup.bam
)

in_reads=(
mVenus-SA-rep5_L1_R1.genome.Aligned.sort.dedup.bam
mVenus-SA-rep6_L2_R1.genome.Aligned.sort.dedup.bam
)

ip_peaks=(
SNRNP70-SA-rep1_L1_R1.peaks.bed
SNRNP70-SA-rep2_L2_R1.peaks.bed
)

ip_readnum=(
SNRNP70-SA-rep1_L1_R1.genome.Aligned.sort.dedup.bam.readnum
SNRNP70-SA-rep2_L2_R1.genome.Aligned.sort.dedup.bam.readnum
)

in_readnum=(
mVenus-SA-rep5_L1_R1.genome.Aligned.sort.dedup.bam.readnum
mVenus-SA-rep6_L2_R1.genome.Aligned.sort.dedup.bam.readnum
)
