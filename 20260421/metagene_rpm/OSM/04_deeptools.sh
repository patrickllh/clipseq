...
-o SNRNP70-Sorbitol-rep1.3utr.skipzeros.mat.gz

mrna=$(zcat SNRNP70-Sorbitol-rep1.3utr.skipzeros.mat.gz | wc -l)
...
--sortUsingSamples 1 \
-m SNRNP70-Sorbitol-rep1.3utr.skipzeros.mat.gz \
-o SNRNP70-Sorbitol-rep1.3utr.skipzeros.heat.pdf \
--outFileSortedRegions SNRNP70-Sorbitol-rep1.3utr.skipzeros.heat.bed
...
-o SNRNP70-Sorbitol-rep2.3utr.skipzeros.mat.gz

mrna=$(zcat SNRNP70-Sorbitol-rep2.3utr.skipzeros.mat.gz | wc -l)
...
--sortUsingSamples 1 \
-m SNRNP70-Sorbitol-rep2.3utr.skipzeros.mat.gz \
-o SNRNP70-Sorbitol-rep2.3utr.skipzeros.heat.pdf \
--outFileSortedRegions SNRNP70-Sorbitol-rep2.3utr.skipzeros.heat.bed
