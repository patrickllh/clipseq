...
reads_trimmed=(
SNRNP70-Sorbitol-rep1_L1_R1.trimmed.fq.gz 
SNRNP70-Sorbitol-rep2_L2_R1.trimmed.fq.gz
mVenus-Sorbitol-rep5_L1_R1.trimmed.fq.gz 
mVenus-Sorbitol-rep6_L2_R1.trimmed.fq.gz
)
