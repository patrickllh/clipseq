...
#SBATCH --job-name=02f_UMICollapse
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
mappings_sorted=(
SNRNP70-Sorbitol-rep1_L1_R1.genome.Aligned.sort.bam
SNRNP70-Sorbitol-rep2_L2_R1.genome.Aligned.sort.bam
mVenus-Sorbitol-rep5_L1_R1.genome.Aligned.sort.bam
mVenus-Sorbitol-rep6_L2_R1.genome.Aligned.sort.bam
)
