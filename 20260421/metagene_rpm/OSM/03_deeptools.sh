...
-o SNRNP70-Sorbitol-rep1.cds.skipzeros.mat.gz

mrna=$(zcat SNRNP70-Sorbitol-rep1.cds.skipzeros.mat.gz | wc -l)
...
--sortUsingSamples 1 \
-m SNRNP70-Sorbitol-rep1.cds.skipzeros.mat.gz \
-o SNRNP70-Sorbitol-rep1.cds.skipzeros.heat.pdf \
--outFileSortedRegions SNRNP70-Sorbitol-rep1.cds.skipzeros.heat.bed
...
-o SNRNP70-Sorbitol-rep2.cds.skipzeros.mat.gz

mrna=$(zcat SNRNP70-Sorbitol-rep2.cds.skipzeros.mat.gz | wc -l)
...
--sortUsingSamples 1 \
-m SNRNP70-Sorbitol-rep2.cds.skipzeros.mat.gz \
-o SNRNP70-Sorbitol-rep2.cds.skipzeros.heat.pdf \
--outFileSortedRegions SNRNP70-Sorbitol-rep2.cds.skipzeros.heat.bed
