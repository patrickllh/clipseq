...
mappings=(
SNRNP70-SA-rep1_L1_R1.genome.Aligned.out.bam
SNRNP70-SA-rep2_L2_R1.genome.Aligned.out.bam
mVenus-SA-rep5_L1_R1.genome.Aligned.out.bam
mVenus-SA-rep6_L2_R1.genome.Aligned.out.bam
)
